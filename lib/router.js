...
router.put("/update-candidate-bio", isJwtValid, bodyParser, isCandidate, candidateController.updateBio)
...
router.get("/get-job-candidate", isJwtValid, jobController.getJobCandidate)
...
//Department
router.get("/get-departments", isJwtValid, departmentController.getDepartments)
